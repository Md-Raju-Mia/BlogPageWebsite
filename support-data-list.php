...
<head>
  ...
  <title>Mobile Device Management | 24/7 Support - MobiManager</title>
  ...
  <meta name="og:title" content="Mobile Device Management | 24/7 Support - MobiManager">
  <meta name="og:description" content="Explore peace of mind with our dedicated 24/7 Support for MobiManager Mobile Device Management. Our expert team is here around the clock to address your inquiries, troubleshoot issues, and provide timely assistance. Count on reliable support that ensures your MobiManager experience is seamless and efficient. Reach out anytime; we're here to help you maximize the benefits of MobiManager MDM">
  ...
  <meta name="og:keywords" content="MobiManager contact, mobile device management support, MobiManager inquiries, device management solutions, MobiManager collaboration, mobile device management assistance, contact us for MobiManager, device management experts, support for MobiManager, mobile device management solutions, MobiManager is the best Mobile Device Solution (MDM) Software provider in bangladesh.">
            ...
            <div class="row">
              <div class="card mt-3 card-shadow">
                <div class="card-body">
                  ...
                  <h3 class="text-center text-w">Request for Support</h3>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <table class="table table-striped table-hover" id="supportTable">
                            <thead>
                              <tr>
                                <!-- <th>ID</th> -->
                                <th>Ticket Number</th>
  ...
  <script>
    $(document).ready(function() {
      $('#supportTable').DataTable({
        responsive: true,
        "ajax": "forms/get_support_data.php",
        "columns": [
          /*{ "data": "id"},*/
...

          {
            ...
            "fnCreatedCell": function(nTd, sData, oData, iRow, iCol) {
              ...
              $(nTd).html("<a style='margin-right: 3px;padding: 3px 7px;' class='btn btn-danger' onclick='deleteEntry(" + oData.id + ");' href='./delete-support-data-list.php?id=" + oData.id + "'><i class='fa fa-trash'></i></a><a style='margin-right: 3px;padding: 3px 6px;' class='btn btn-info'  href='./edit-support-data-list.php?id=" + oData.id + "'><i class='fa fa-pencil'></i></a>");
