...
<head>
  ...
  <title>Request a Demo - MobiManager</title>
  <meta name="description" content="Experience the power of MobiManager with a personalized demo. Explore our comprehensive mobile device management solutions and discover how they can benefit your organization. Request a demo today!">
  <meta name="keywords" content="request demo, mobimanager demo, mobile device management demo, demo request, mdm demo, demo mobimanager">
  <meta name="og:keywords" content="request demo, mobimanager demo, mobile device management demo, demo request, mdm demo, demo mobimanager">
  <meta property="og:type" content="website">
  <meta name="og:title" content="Request a Demo - MobiManager">
  <meta name="og:description" content="Experience the power of MobiManager with a personalized demo. Explore our comprehensive mobile device management solutions and discover how they can benefit your organization. Request a demo today!">
            ...
            <div class="row">
              <div class="card mt-3 card-shadow">
                <div class="card-body">
                  ...
                  <h3 class="text-center text-w">Request for Demo</h3>
  ...
  <script>
    $(document).ready(function() {
      $('#supportTable').DataTable({
        responsive: true,
        "ajax": "forms/get_request_a_demo_data.php",
        "columns": [
          /*{ "data": "id"},*/
