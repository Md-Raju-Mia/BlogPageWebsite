          ...
          components: [
            {
              dom: {
                tag: "a",
                attributes: {
                  href: "https://www.inovexidea.com/",
                  rel: "noopener",
                  target: "_blank",
                  "aria-hidden": "true",
                },
                classes: ["tox-promotion-link"],
                innerHtml: "\u26a1\ufe0fInovex Idea Solution Ltd.",
              },
            },
          ],
        }),
                  ...
                  components: [
                    {
                      dom: {
                        tag: "a",
                        attributes: {
                          href: "https://www.mobi-manager.com/",
                          rel: "noopener",
                          target: "_blank",
                        ...
                        innerHtml: 
                        `<svg width="50px" height="16px" viewBox="0 0 50 16" xmlns="http://www.w3.org/2000/svg"><text x="8" y="12" font-family="Arial" fill="black" >MobiManager</text></svg>`.trim(),
                      },
