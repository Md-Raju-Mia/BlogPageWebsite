...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mobile = $_POST['mobile'];
    $numberOfSubscription = $_POST['numberOfSubscription'];
    $userType = $_POST['userType'];
    $comments = $_POST['comments'];

    // Insert data into the database
    $sql = "INSERT INTO request_demo (name, email, orgName, mobile, numberOfSubscription,userType, comments)
            VALUES ('$name', '$email', '$orgName', '$mobile', '$numberOfSubscription','$userType', '$comments')";
